...
namespace Seq.App.Teams.Models
{
    ...
    public partial class O365ConnectorCardOpenUri : O365ConnectorCardActionBase
    {
        ...
        public O365ConnectorCardOpenUri(string type = "OpenUri", string name = default(string), string id = default(string), System.Collections.Generic.IList<O365ConnectorCardOpenUriTarget> targets = default(System.Collections.Generic.IList<O365ConnectorCardOpenUriTarget>))
            : base(type, name, id)
        {
            Targets = targets;
        }
